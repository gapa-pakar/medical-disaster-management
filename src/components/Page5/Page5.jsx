...
const questions = [
    ...
    },
    {
        ...
        answer:
            [
                'אמצעים לדיווח בדרג המחלקתי: ללא אמצעי קשר, יתבסס על חפ"ק מ"מ.',
                'אמצעים לדיווח בדרג הפלוגתי: ברק כתום, שוע"ל ע"ב במ"פ חילוץ.',
                'אמצעים לדיווח בדרג הגדודי: שוע"ל, ברק כתום.'
            ],
        width: '26vw'
    }
]
